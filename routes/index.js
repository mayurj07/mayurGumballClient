...
var secretKey="GVJGH4H5JH4JH3J478DF78DF78FGD78DFG78DFG78G";
...
exports.index = function(req, res) {
	...
	// direct way
	client.get("http://gumballmayurserver-mayurj07.rhcloud.com/", function(data,
			response) {
	...
	if (action === 'TurnTheCrank' && state === 'HasACoin') {
		...
		client.get("http://gumballmayurserver-mayurj07.rhcloud.com/", function(data,
			...
			if (count !== 0) {
				...
				client.put("http://gumballmayurserver-mayurj07.rhcloud.com/gumball/1", args,
						function(data, response) {
							// parsed response body as js object
							console.log(data);
							// raw response
							console.log(response);
							var msg="\n\n Gumball Extra Credit INC \n Model#"+modelNumber+"\n"+"Serial #"+serialNumber+"\n"+"\n"+state+"\n\n";
							res.render('index', {
								message : msg,state:state,ts:ts,hash:getHash(state,ts),modelNumber:modelNumber,serialNumber:serialNumber
							});
						});
